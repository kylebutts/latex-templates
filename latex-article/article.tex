...
See below for Theorem \ref{residue_thm}, for the regression specification Equation \ref{fe_reg}, and for Table \ref{summ_stat}, appendix table \ref{reg1}, and citation \citep{Eigen1971}. 
...
\begin{table}[tb] 
    ...
    \begin{adjustbox}{center}
        \begin{tabularx}{\textwidth}{@{} 
            ...
            % Notes
            \hline \hline \\[-5mm]
            \multicolumn{4}{@{} L}{\small\textit{Source.} \href{https://en.wikipedia.org/wiki/List_of_countries_by_population_(United_Nations)}{Wikipedia}.}
